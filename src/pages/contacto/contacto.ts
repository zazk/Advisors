...
export class ContactoPage {
  ...
  constructor(
    ...
    this.telefonos.push({
      ciudad: "Lima",
      numero: "(01) 200 4 200",
      concatenado: "Lima (01) 200 4 200"
    });
    this.telefonos.push({
      ciudad: "Arequipa",
      numero: "(054) 38 03 03",
      concatenado: "Arequipa (054) 38 03 03"
    });
    this.telefonos.push({
      ciudad: "Tacna",
      numero: "(052) 42 82 82",
      concatenado: "Tacna (052) 42 82 82"
    });
    this.telefonos.push({
      ciudad: "Ilo",
      numero: "(053) 48 28 36",
      concatenado: "Ilo (053) 48 28 36"
    });
  }
  ...
  ionViewDidLoad() {
    ...
    // TODO This was modified because fails when user is null
    const user = this.vars.getUsuario();
    if (user) {
      this.data.DocumentoIdentidad = user.userName;
      this.data.Usuario = user.Nombres;
    }
  }
  resize() {
    this.myInput.nativeElement.style.height =
      this.myInput.nativeElement.height + "px";
  }
